  ...
  return (
    <div className='flex min-h-screen'>
      <div className='flex-1 flex-row'>
        <div className='max-w-[800px] w-11/12 mx-auto'>
      ...
      <div data-aos="fade-left" className='flex-1 bg-[#FAFDF0]'>
        <div className='max-w-[800px] w-11/12 mx-auto flex justify-center items-center min-h-screen'>
