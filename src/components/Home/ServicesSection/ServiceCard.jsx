...
const ServiceCard = ({ service }) => {
  ...
  return (
    <div data-aos="fade-right" className='bg-white px-6 py-8 rounded-xl hover:bg-[#CAEB66] hover:-translate-y-0.5 duration-300 flex flex-col text-center items-center transition-all'>
