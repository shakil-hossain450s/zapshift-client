...
const MyParcelRow = ({ parcel, index }) => {
          ...
          ">
            <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: clamp(12px, 3vw, 16px); flex-wrap: wrap; gap: 12px;">
              <div style="flex: 1; min-width: 120px;">
                ...
                <div style="font-size: clamp(0.9rem, 3vw, 1rem); font-weight: 600; color: #1f2937;">${parcel.parcelType.charAt(0).toUpperCase() + parcelType.slice(1)}</div>
              </div>
  ...
  return (
    <tr className="hover:bg-gray-50">
      ...
      <td className='flex gap-1'>
        {parcelName}
        <span className='badge badge-sm'>{parcelType.charAt(0).toUpperCase() + parcelType.slice(1)}</span>
      </td>
      <td>৳{deliveryCost}</td>
